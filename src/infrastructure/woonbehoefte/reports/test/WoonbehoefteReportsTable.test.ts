...
describe('WoonbehoefteReportsTable', () => {
  const stack = new Stack(new App(), 'TestStack');
  const reportsTable = new WoonbehoefteReportsTable(stack, 'woonbehoefte-reports');
  ...
  reportsTable.grantWorkerAccess(worker);
  reportsTable.grantFrontendAccess(frontend);
