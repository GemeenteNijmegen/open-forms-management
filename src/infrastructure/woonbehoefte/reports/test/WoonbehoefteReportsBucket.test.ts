...
describe('WoonbehoefteReportsBucket', () => {
  const stack = new Stack(new App(), 'TestStack');
  const reportsBucket = new WoonbehoefteReportsBucket(stack, 'woonbehoefte-reports');
  ...
  reportsBucket.grantWorkerAccess(worker);
  reportsBucket.grantFrontendAccess(frontend);
