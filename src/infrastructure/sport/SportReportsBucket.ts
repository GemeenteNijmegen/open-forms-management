...
/**
 * Object keys are `reports/<reportId>.xlsx`, so the frontend never needs `s3:ListBucket` to find a
 * report - the DynamoDB record already has its key.
 */
export class SportReportsBucket extends Construct {
