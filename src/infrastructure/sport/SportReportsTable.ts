...
/**
 * `reportId` is the only key. Report volume and retention are small enough that listing
 * the non-deleted reports with a Scan doesn't need a GSI.
 */
export class SportReportsTable extends Construct {
